...
import com.lcv.elverapi.apis.hypixelplayer.Bedwars;
import com.lcv.elverapi.apis.hypixelplayer.HypixelPlayer;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        HypixelPlayer hypixelApi = new HypixelPlayer(UUID_WAROG, key);
        Bedwars bwApi = hypixelApi.getBedwarsApi();
