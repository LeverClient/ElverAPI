...
public class DuelsAPI extends SubApi {
    ...
    public int getLosses() {
        return (int) internalApiMap.computeIfAbsent("losses", (k) -> get("losses"));
    }
    ...
    public int getKills() {
        return (int) internalApiMap.computeIfAbsent("kills", (k) -> get("kills"));
    }
    ...
    public int getBowShot() {
        return (int) internalApiMap.computeIfAbsent("bow_shot", (k) -> get("bow_shots"));
    }

    public int getBowHit() {
        return (int) internalApiMap.computeIfAbsent("bow_hit", (k) -> get("bow_hits"));
    }
    ...
    public int getSwordSwung() {
        return (int) internalApiMap.computeIfAbsent("sword_swing", (k) -> get("melee_swings"));
    }

    public int getSwordHit() {
        return (int) internalApiMap.computeIfAbsent("sword_hit", (k) -> get("melee_hits"));
    }
    ...
    public int getHealthHealed() {
        return (int) internalApiMap.computeIfAbsent("health_healed", (k) -> get("health_regenerated"));
    }

    public int getDamageDealt() {
        return (int) internalApiMap.computeIfAbsent("damage_dealt", (k) -> get("damage_dealt"));
    }

    public int getCoins() {
        return (int) internalApiMap.computeIfAbsent("coins", (k) -> get("coins"));
    }

    public int getPingPreference() {
        return (int) internalApiMap.computeIfAbsent("ping_preference", (k) -> get("pingPreference"));
    }
    ...
    public String getRankFormatted() {
        String rank = getRank();
        return (String) internalApiMap.computeIfAbsent("prestige_formatted", (k) -> formatRank(rank));
    }
